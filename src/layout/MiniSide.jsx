    ...
    return (
        <>
            <MiniContainer>
                ...
                <Ulstyle>
                    <div>
                        <Liststyle to="/home"><IoHomeOutline className='icon' /></Liststyle>
                        <Liststyle to="/search"><LuSearch className='icon' /></Liststyle>
                        ...
                        <Liststyle><FaRegBell className='icon' /></Liststyle>
                    ...
                    <div>
                        <Liststyle onClick={openSetting}><IoSettingsOutline className='icon' /></Liststyle>
                    </div>
                </Ulstyle>
            </MiniContainer>
