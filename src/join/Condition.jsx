        ...
        <AgreementLabel>
            ...
            <AgreementBox>
              <div style={{marginRight:'auto'}}>
                <AgreementInput type='checkbox'style={{marginRight: '5px'}}></AgreementInput>
                <AgreementSpan style={{fontSize: '0.9rem'}}>모두동의합니다.</AgreementSpan>
              </div>
              <div style={{marginRight:'auto', marginTop: '5px'}}>
                <AgreementSpan>수집하는 개인정보 항목

필수 항목: 성명, 생년월일, 연락처(이메일, 전화번호)
선택 항목: 주소, 성별, 직업
개인정보 수집 및 이용 목적

회원 가입 및 관리: 본인 확인, 회원 식별
서비스 제공: 맞춤형 서비스 제공 및 이용자 간의 커뮤니케이션
  </AgreementSpan>
              </div>
            </AgreementBox>
        ...
        <AgreementLabel>
        <AgreementTitle  style={{marginTop: '10px'}}>[필수]민간정보 수집이용</AgreementTitle>
            <AgreementBox style={{ border: '2px solid #706EF4', opacity: '0.49', background: 'white'}}>
              <AgreementSpan><pre>
              {str}</pre></AgreementSpan>
            </AgreementBox>
        </AgreementLabel>
        <AgreementBox style={{flexDirection: 'row', marginBottom: '25px'}}>
            <AgreementRadioLabel>민감정보 수집 및 이용에 대한 안내 사항을 읽고 동의합니다.</AgreementRadioLabel>
            <AgreementCheckboxLabel style={{display: 'flex', justifyContent: 'flex-end'}}>
                <AgreementInput type="radio" checked={radioChecked} onChange={() => setRadioChecked(!radioChecked)} />
                <AgreementSpan style={{fontSize: '0.8rem', marginRight: '5px'}}>동의하지 않음</AgreementSpan>
                <AgreementInput type="radio" checked={!radioChecked} onChange={() => setRadioChecked(!radioChecked)} />
                <AgreementSpan style={{fontSize: '0.8rem'}}>동의</AgreementSpan>
            </AgreementCheckboxLabel>
        </AgreementBox>
        <div>
          <NextButton>이어서 진행</NextButton>
        </div>
    </ConditionBox>
  )
}
